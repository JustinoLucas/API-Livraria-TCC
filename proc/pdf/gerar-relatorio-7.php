...
$sql = "SELECT * FROM `movimento` WHERE data_movimento BETWEEN DATE_SUB(NOW(), INTERVAL 7 DAY) AND NOW() ORDER BY id ASC;";
...
$dados .= "<link rel='stylesheet' href='../../../css/pdf.css'>";
$dados .= "</head>";
$dados .= "<body>";
$dados .= "<h1>Relátorio de 7 Dias</h1>";
