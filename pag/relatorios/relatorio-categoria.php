        ...
        ?>
                <div class="pesquisa3">
                    ...
                    <?php
                                ...
                                $disableBtn = 'hidden';
                                echo '<div class="pesquisa3">Nenhum movimento de estoque encontrado com essa Categoria.</div>';
                            }
                    ?>
                <?php
            }
                ?>
                    ...
                    <form method="POST" action="/proc/pdf/gerar-relatorio-cate.php" class="tabela-tipo-relatorio">
