...
<body>
    ...
    ?>
    <div>
        <h1>Relátorio dos ultimos 7 Dias</h1>
    </div>
    <?php

    include '../../config/conexao.php';

    $sql = "SELECT * FROM `movimento` WHERE data_movimento BETWEEN DATE_SUB(NOW(), INTERVAL 7 DAY)
    ...
    <div class="pesquisa">
        ...
        <form method="POST" action="/proc/pdf/gerar-relatorio-7.php" class="tabela-tipo-relatorio">
